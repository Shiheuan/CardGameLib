...
namespace CardClient
{
    public class GameManager
    {
        ...
        public void SetPlayers(Player[] newPlayers)
        {
            ...
            {
                throw new ArgumentException("A maximum of 7 players may play the game.");
            }
            if (newPlayers.Length < 2)
            {
                throw new ArgumentException("A minimum of 2 players may play the game.");
            }
            players = newPlayers;
        }
        ...
        public int PlayGame()
        {
            ...
            // Initialize game vars, including an initial card to place on 
            // the table: PlayCard
            bool GameWon = false;
            int currentPlayer;
            ...
            // Main game loop, continues untill GameWon == true.
            do
            {
